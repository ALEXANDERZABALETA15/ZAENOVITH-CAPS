...
import { getGorrasNuevas } from '@/lib/getGorras'
...
export default function NovedadesPage() {
  ...
  useEffect(() => {
    async function cargar() {
      const data = await getGorrasNuevas()
      setGorras(data)
      setCargando(false)
    }
    cargar()
      ...
      <div style={{
        ...
        >
          ...
          <p style={{
            ...
            Las ultimas piezas que llegaron a CROWNLUX. Se el primero en tenerlas.
          </p>
        </motion.div>
